-- Wireshark Lua dissector for test_24_03_25 on IP 192.168.50.3
-- Generated automatically from DPI JSON.

local test_24_03_25_192_168_50_3 = Proto("test_24_03_25_192_168_50_3", "test_24_03_25 for IP 192.168.50.3")

local f_header = ProtoField.string("test_24_03_25_192_168_50_3.header", "Header")
local f_version = ProtoField.uint32("test_24_03_25_192_168_50_3.version", "Version"), base.DEC
local f_flags1 = ProtoField.uint8("test_24_03_25_192_168_50_3.flags1", "Flags1 (Bitfield)")
local f_flags2 = ProtoField.uint8("test_24_03_25_192_168_50_3.flags2", "Flags2 (Bitfield)")
local f_temperature = ProtoField.string("test_24_03_25_192_168_50_3.temperature", "Temperature")
local f_pressure = ProtoField.string("test_24_03_25_192_168_50_3.pressure", "Pressure")
local f_device_id = ProtoField.string("test_24_03_25_192_168_50_3.device_id", "Device_id")
local f_message_length = ProtoField.uint32("test_24_03_25_192_168_50_3.message_length", "Message_length"), base.DEC
local f_message = ProtoField.string("test_24_03_25_192_168_50_3.message", "Message")
local f_checksum = ProtoField.uint32("test_24_03_25_192_168_50_3.checksum", "Checksum"), base.DEC

test_24_03_25_192_168_50_3.fields = { f_header, f_version, f_flags1, f_flags2, f_temperature, f_pressure, f_device_id, f_message_length, f_message, f_checksum }

function test_24_03_25_192_168_50_3.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "test_24_03_25"
    local subtree = tree:add(test_24_03_25_192_168_50_3, buffer(), "test_24_03_25 for IP 192.168.50.3")
    local offset = 0
    ...
    do
        local min_val = 334157322.0
        local max_val = 4006400497.0
...
udp_port:add(10000, test_24_03_25_192_168_50_3)
